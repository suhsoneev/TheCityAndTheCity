...
group_1 =  json.dumps(generate_js_object_and_html(os.path.join(content_path, "group_1")), indent=4)
group_2 = json.dumps(generate_js_object_and_html(os.path.join(content_path, "group_2")), indent=4)
group_3 = json.dumps(generate_js_object_and_html(os.path.join(content_path, "group_3")), indent=4)
group_4 = json.dumps(generate_js_object_and_html(os.path.join(content_path, "group_4")), indent=4)

# # Convert the JavaScript object to JSON
# group_1_json = json.dumps(group_1, indent=4)
# group_2_json = json.dumps(group_2, indent=4)

# Save the JavaScript object as a JS file
with open("data.js", "w") as file:
    file.write(f"var group_1 = {group_1} \nvar group_2 = {group_2} \nvar group_3 = {group_3} \nvar group_4 = {group_4} \n")
